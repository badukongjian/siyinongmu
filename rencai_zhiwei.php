...
<center><div class="nybanner" styl</center>e="background:url(images/zhaopinlogo.png) no-repeat center; width:1000px; height:300px;"></div>
</center>
<div class="main">
    <div class="main_01">
        <div class="left">
                    ...
                    <div>
                        ...
                        <div class="gsjj">
                            <div class="deta-Corp" style="border-bottom: 0px; border-left: 0px; padding-bottom: 0px; line-height: 25px; margin: 20px 0px 0px; outline-style: none; outline-color: invert; padding-left: 0px; outline-width: 0px; padding-right: 0px; font-family: arial, 宋体; color: rgb(75,75,75); font-size: 14px; border-top: 0px; border-right: 0px; padding-top: 0px">
                                <p><font color="red" size="5">招聘职位----------------------------------------------人数</font></p><br/>
                                <p><font color="red" size="5">销售工程师--------------------------------------------2名</font></p><br/>
                                <p><font color="red" size="5">管理工程师--------------------------------------------3名</font></p><br/>
                                <p><font color="red" size="5">农学工程师--------------------------------------------1名</font></p><br/>
                                <p><font color="red" size="5">园艺工程师--------------------------------------------1名</font></p>
                            </div>
                        </div>
                    </div>
