                        ...
                        <tr>
                            <td height="30" align="center"><table  border="0"  cellpadding="0" cellspacing="0" >
                                    ...
                                    <tr><td id="table1"  style=" ; text-align:left; line-height:25px; padding-left:20px; font-size:12px;" >
                                            ...
                                            <a href="product/xj.php"> >>  香蕉</a> <br>



                                                <a href="product/fsl.php"> >>  番石榴</a> <br>



                                                    <a href="product/qc.php"> >>  芹菜</a> <br>



                                                        <a href="product/gz.php"> >>  甘蔗</a> <br>



                                                            <a href="product/bxg.php"> >>  百香果</a> <br>



                                                                <a href="product/yz.php"> >>  柚子</a> <br>
            ...
            <div class="right_01">
                ...
                <div class="right_01_tex">
                    <div>
                        ...
                        <div class="photo">
                            <ul>
                                <li><span><a href="product/xj.php" ><img src="images/xj.png" width="180"   border="0"  height="150" style="padding:5px; border:1px solid #CCCCCC;"/></a></span><br />
                                    <a href="product/xj.php">香蕉</a></li>
                                <li><span><a href="product/fsl.php" ><img src="images/fsl.png" width="180"   border="0"  height="150" style="padding:5px; border:1px solid #CCCCCC;"/></a></span><br />
                                    <a href="product/fsl.php">番石榴</a></li>
                                <li><span><a href="product/bxg.php" ><img src="images/bxg.png" width="180"   border="0"  height="150" style="padding:5px; border:1px solid #CCCCCC;"/></a></span><br />
                                    <a href="product/bxg.php">百香果</a></li>
                                <li><span><a href="product/qc.php" ><img src="images/qincai.png" width="180"   border="0"  height="150" style="padding:5px; border:1px solid #CCCCCC;"/></a></span><br />
                                    <a href="product/qc.php">芹菜</a></li>
                                <li><span><a href="product/yz.php" ><img src="images/youzi.png" width="180"   border="0"  height="150" style="padding:5px; border:1px solid #CCCCCC;"/></a></span><br />
                                    <a href="product/yz.php">柚子</a></li>
                                <li><span><a href="product/gz.php" ><img src="images/ganzhe.png" width="180"   border="0"  height="150" style="padding:5px; border:1px solid #CCCCCC;"/></a></span><br />
                                    <a href="product/gz.php">甘蔗</a></li>
                            </ul>
