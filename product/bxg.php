...
E-mail：szsmrkj@126.com</span></p>
        ...
        <div class="right">
            <div class="right_01">
                <div class="right_01_title"><span>您当前所在位置：<a href="index.php">首页</a> &gt; 产品&gt;农产品</span>百香果</div>
                <div class="right_01_tex">
                    <div>

                        <div class="photo">
                            <img src="../images/bxg1.png"/>
                            <p>百香果，又叫鸡蛋果、爱情果，学名：西番莲，
                                拉丁文名：Passiflora edulis Sims.。西番莲科、
                                西番莲属草质藤本，茎具细条纹，无毛。叶纸质，中间裂片卵形，
                                两侧裂片卵状长圆形，裂片边缘有内弯腺尖细锯齿，外面顶端
                                具1角状附属器；内副花冠非褶状，顶端全缘或为不规则撕裂状，
                                淡黄绿色；子房倒卵球形，扁棒状，柱头肾形。浆果卵球形，无毛，
                                熟时紫色；种子多数，卵形。原产大小安的列斯群岛，现广植于热带
                                和亚热带地区。果可生食或作蔬菜、饲料。果瓤多汁液，加入碳酸和糖，
                                可制成芳香可口的饮料（碳酸饮料），也可以做成西番莲果派。
                                入药具有兴奋、强壮之效。
                            </p>
                            <img src="../images/bxg2.png"/>
